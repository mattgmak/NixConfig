    ...
    homeModules.zen-browser =
      { pkgs, lib, ... }:
      {
        ...
        programs.zen-browser = {
          ...
          profiles = rec {
            default = rec {
              ...
              keyboardShortcutsVersion = lib.mkIf pkgs.stdenv.isLinux 18;
        ...
        home.file =
          ...
          in
          {
            "${configDir}/default/chrome/modules" = modules;
            "${configDir}/default/chrome/elements" = elements;
            "${configDir}/tmp/chrome/modules" = modules;
            "${configDir}/tmp/chrome/elements" = elements;
          };
      };
  };
}
