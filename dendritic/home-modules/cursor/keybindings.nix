{ flake.cursorKeybindings = [
  ...
  # {
  #   "key" = "ctrl+u";
  #   "command" = "runCommands" #   "when" = "editorTextFocus && neovim.mode != insert";;
  #   "args" = {;
  #     "commands" = [;
  ...
  }
  {
    ...
    # "when" = "(!inputFocus) && neovim.init && neovim.mode == 'normal'";
  }
  ...
  }
  {
    ...
    "when" = "editorFocus && neovim.init && !inputFocus && (neovim.mode == 'normal' || neovim.mode == 'visual') || neovim.init && !inputFocus && !searchInputBoxFocus && neovim.mode == 'normal'";
  }
  {
    "key" = "space s r";
    "args" = " sr";
  ...
  #   "key" = "tab";
  #   "command" = "tab";
  #   "when" = "neovim.init && neovim.mode == 'insert' && !suggestionCanResolve";
  # }
]; }
