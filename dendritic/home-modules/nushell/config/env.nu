...
def create_left_prompt [] {
    let home_dir = try { $nu.home-dir } catch { $nu.home-path }
    let dir = match (do --ignore-errors { $env.PWD | path relative-to $home_dir }) {
        null => $env.PWD
        '' => '~'
...
$env.PATH = ($env.PATH | append "/etc/profiles/per-user/mattgmak/bin")
