...
if is_vscode then
  ...
  vim.keymap.set('n', '<leader>vr', function() vscode.call('editor.action.inlineDiffs.rejectPartialEdit') end)
  vim.keymap.set('n', '<leader>var', function() vscode.call('editor.action.inlineDiffs.rejectAll') end)
  vim.keymap.set('n', '<leader>vn', function() vscode.call('editor.action.inlineDiffs.nextChange') end)
  vim.keymap.set('n', '<leader>vb', function() vscode.call('editor.action.inlineDiffs.previousChange') end)
  vim.keymap.set('n', '<leader>vf', function() vscode.call('editor.action.inlineDiffs.nextDiffFile') end)
  vim.keymap.set('n', '<leader>vp', function() vscode.call('editor.action.inlineDiffs.previousDiffFile') end)
  ...
  vim.keymap.set('n', '<leader>t', function() vscode.call('workbench.action.files.saveWithoutFormatting') end)
...
end, { desc = 'Wrap selection in inline console.log expression' })
