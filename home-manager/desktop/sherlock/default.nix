    ...
    in {
      config = {
        ...
        appearance = {
          ...
          height = 593;
          gsk_renderer = "cairo";
          icon_paths = [ "${home}/.config/sherlock/icons" ];
          icon_size = 40;
          use_base_css = false;
          opacity = 1.0;
          mod_key_ascii = [ "⇧" "⇧" "󰘴" "⌘" "⎇" "✦" "✦" "⌘" ];
        ...
        files = {
          config = "${home}/.config/sherlock/config.toml";
          css = "${home}/.config/sherlock/main.css";
          fallback = "${home}/.config/sherlock/fallback.json";
          alias = "${home}/.config/sherlock/sherlock_alias.json";
          ignore = "${home}/.config/sherlock/sherlockignore";
          actions = "${home}/.config/sherlock/sherlock_actions.json";
        };
        runtime = {
          multi = false;
          center = false;
        ...
        caching = {
          enable = true;
          cache = "${home}/.cache/sherlock/sherlock_desktop_cache.json";
        };
        expand = {
          enable = false;
          edge = "top";
      ...
      aliases = {
        Vesktop = {
          ...
          icon = "discord";
          exec =
            "vesktop --enable-features=UseOzonePlatform --ozone-platform=wayland --enable-wayland-ime %U";
          keywords = "discord";
        };
        Cursor = {
          name = "Cursor";
      ...
      style = ''
        ...
        * {
          ...
          line-height: 1;
          font-family: "IosevkaTerm Nerd Font Propo", "Noto Sans CJK HK";
        }
        ...
        .tag {
          ...
          box-shadow: 0px 0pxasd10px 0px rgba(2, 2, 2, 0.4);
