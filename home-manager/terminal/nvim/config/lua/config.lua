...
if is_vscode then
  ...
  vim.keymap.set('n', '<leader><leader>', function() vscode.call('find-it-faster.findFiles') end)
  ...
  vim.keymap.set('n', '<leader>jf', function() vscode.call('find-it-faster.findWithinFiles') end)
